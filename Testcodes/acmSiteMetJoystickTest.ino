      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println(".void {background-color: lightblue; pointer-events: none;}");
            ...
            if (autonomous) {
              client.println("<p><a href=\"/mode/manual\"><button class=\"button button2\">Autonomous</button></a></p>");
            } else {
              client.println("<p><a href=\"/mode/autonomous\"><button class=\"button button2\">Manual</button></a></p>");
            } 
            ...
            if (manual) {   
              ...
              client.println("<p><a><button class=\"button void\"><i class=\"arrow arrowvoid\"></i></button></a><a href=\"/forward/on\"><button class=\"button button\"><i class=\"arrow up\"></i></button></a></p>");
              ...
              client.println("<p><a><button class=\"button void\"><i class=\"arrow arrowvoid\"></i></button></a><a href=\"/backward/on\"><button class=\"button button\"><i class=\"arrow down\"></i></button></a></p>");
            }
